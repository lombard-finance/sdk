...
import { useBtcDepositSui } from '../useBtcDepositSui';

describe('useBtcDepositSui', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  it('returns idle state when no suiWallet provided', () => {
    const result = useBtcDepositSui(undefined, undefined);
  ...
  it('creates SDK config with sui provider when both wallet and walletAccount exist', () => {
    ...
    useBtcDepositSui(mockWallet, mockAccount);
  ...
  it('passes partnerId to config when provided', () => {
    ...
    useBtcDepositSui(mockWallet, mockAccount, 'partner-123');
  ...
  it('delegates stake call correctly with proper chain mapping', () => {
    ...
    const result = useBtcDepositSui(mockWallet, mockAccount);
