...
import { SuiWithdrawingForm } from '../SuiWithdrawingForm';

describe('SuiWithdrawingForm', () => {
  let root: Root;
  ...
  function renderForm(
    props: Partial<React.ComponentProps<typeof SuiWithdrawingForm>> = {},
  ) {
    ...
    act(() => {
      root.render(<SuiWithdrawingForm {...defaultProps} />);
    });
