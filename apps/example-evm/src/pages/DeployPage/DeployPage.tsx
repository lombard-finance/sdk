...
import { DeployingProgress } from '../../components/DeployingProgress';
import { WalletConnect } from '../../components/WalletConnect';
import { useEvmWallet } from '../../hooks/useEvmWallet';
import { useBtcDeploy } from './useBtcDeploy';
...
export function DeployPage({ env }: StakeAndDeployPageProps) {
  if (env !== Env.prod) {
...
function StakeAndDeployPageInner({ env }: StakeAndDeployPageProps) {
  ...
  const {
    ...
    progress,
    reset,
  } = useBtcDeploy(protocol, partnerId, env);
