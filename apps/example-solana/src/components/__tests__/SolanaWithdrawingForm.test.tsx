...
import { SolanaWithdrawingForm } from '../SolanaWithdrawingForm';

describe('SolanaWithdrawingForm', () => {
  let root: Root;
  ...
  function renderForm(
    props: Partial<React.ComponentProps<typeof SolanaWithdrawingForm>> = {},
  ) {
    ...
    act(() => {
      root.render(<SolanaWithdrawingForm {...defaultProps} />);
    });
