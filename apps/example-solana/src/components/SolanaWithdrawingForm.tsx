...
import type { SolanaWithdrawingFormData } from '../pages/SolanaWithdrawPage/useSolanaUnstaking';

interface SolanaWithdrawingFormProps {
  onSubmit: (formData: SolanaWithdrawingFormData) => Promise<void>;
  isLoading: boolean;
  disabled?: boolean;
  env: Env;
}
 ...
 */
export function SolanaWithdrawingForm({
  onSubmit,
  isLoading,
  disabled = false,
  env,
}: SolanaWithdrawingFormProps) {
