...
import { SolanaWithdrawingForm } from '../../components/SolanaWithdrawingForm';
import { SolanaWithdrawingProgress } from '../../components/SolanaWithdrawingProgress';
import { SolanaWalletConnect } from '../../components/SolanaWalletConnect';
import { useSolanaWallet } from '../../hooks/useSolanaWallet';
import type { SolanaWithdrawingFormData } from './useSolanaUnstaking';
import { useSolanaUnstaking } from './useSolanaUnstaking';

interface SolanaWithdrawPageProps {
  env: Env;
  onReset?: () => void;
}
 ...
 */
export function SolanaWithdrawPage({ env, onReset }: SolanaWithdrawPageProps) {
  ...
  const handleStartUnstaking = async (formData: SolanaWithdrawingFormData) => {
    setIsUnstaking(true);
