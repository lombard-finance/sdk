 ...
 */
export interface SolanaWithdrawingFormData {
  amount: string;
  sourceChain: Chain;
  destChain: Chain;
  recipient: string;
 ...
 */
export type { WithdrawStatus as SolanaWithdrawingStatus } from '@lombard.finance/sdk-react';
...
export function useSolanaUnstaking(solanaAddress?: string | null, env?: Env) {
  ...
  const unstake = useCallback(
    (formData: SolanaWithdrawingFormData) =>
      unstakeCore({
