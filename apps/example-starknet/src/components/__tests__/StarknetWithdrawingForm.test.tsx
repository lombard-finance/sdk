...
import { StarknetWithdrawingForm } from '../StarknetWithdrawingForm';

describe('StarknetWithdrawingForm', () => {
  let root: Root;
  ...
  function renderForm(
    props: Partial<React.ComponentProps<typeof StarknetWithdrawingForm>> = {},
  ) {
    ...
    act(() => {
      root.render(<StarknetWithdrawingForm {...defaultProps} />);
    });
