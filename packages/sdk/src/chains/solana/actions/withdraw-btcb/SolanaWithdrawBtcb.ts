 ...
 *
 * @module chains/solana/actions/withdraw-btcb/SolanaWithdrawBtcb
 */
...
export class SolanaWithdrawBtcb
  extends BaseAction<ActionEventMap, NonEvmOperationStatus>
  implements ISolanaWithdrawBtcb
{
  ...
  constructor(
    ...
    private readonly params: SolanaWithdrawBtcbParams,
  ) {
  ...
  async prepare(params: SolanaWithdrawBtcbPrepareParams): Promise<void> {
