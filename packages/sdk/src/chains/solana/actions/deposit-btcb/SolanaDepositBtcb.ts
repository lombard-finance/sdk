 ...
 *
 * @module chains/solana/actions/deposit-btcb/SolanaDepositBtcb
 */
...
export class SolanaDepositBtcb
  extends BaseAction<ActionEventMap, NonEvmOperationStatus>
  implements ISolanaDepositBtcb
{
  ...
  constructor(
    ...
    private readonly params: SolanaDepositBtcbParams,
  ) {
  ...
  async prepare(params: SolanaDepositBtcbPrepareParams): Promise<void> {
