 ...
 *
 * @module chains/btc/actions/deploy-btcb/types
 */
import type {
  AssetId,
  Chain,
 ...
 */
export interface BtcDeployBtcbParams {
  /** Input asset (BTC) */
  assetIn?: AssetId;
 ...
 * Prepare parameters
 */
export interface BtcDeployBtcbPrepareParams {
 ...
 */
export interface BtcDeployBtcbProgress extends StrategyProgress<BtcActionStatus> {
 ...
 */
export interface BtcDeployBtcb extends MonitorableAction {
   ...
   */
  prepare(params: BtcDeployBtcbPrepareParams): Promise<void>;
