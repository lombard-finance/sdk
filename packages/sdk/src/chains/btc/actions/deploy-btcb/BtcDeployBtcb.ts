 ...
 *
 * @module chains/btc/actions/deploy-btcb/BtcDeployBtcb
 */
 ...
 * @example
 * ```typescript
 * const depositAndDeploy = new BtcDeployBtcb(ctx, {
 ...
 * ```
 */
export class BtcDeployBtcb
  extends BaseBtcAction<ActionEventMap, BtcActionStatus, BtcDeployBtcbParams>
  implements IBtcDeployBtcb
{
  private readonly chainId: ChainId;
  private readonly authState: AuthState = { authorized: false };

  constructor(ctx: BtcCoreContext, params: BtcDeployBtcbParams) {
  ...
  async prepare(params: BtcDeployBtcbPrepareParams): Promise<void> {
