 ...
 *
 * @module chains/btc/actions/deploy-lbtc/types
 */
import type {
  AssetId,
  Chain,
 ...
 */
export interface BtcDeployLbtcParams {
  /** Input asset (BTC) */
  assetIn?: AssetId;
 ...
 * Prepare parameters
 */
export interface BtcDeployLbtcPrepareParams {
 ...
 */
export interface BtcDeployLbtcProgress extends StrategyProgress<BtcActionStatus> {
 ...
 */
export interface BtcDeployLbtc extends MonitorableAction {
   ...
   */
  prepare(params: BtcDeployLbtcPrepareParams): Promise<void>;
