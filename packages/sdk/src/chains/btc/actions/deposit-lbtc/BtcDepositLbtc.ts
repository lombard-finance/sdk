 ...
 *
 * @module chains/btc/actions/deposit-lbtc/BtcDepositLbtc
 */
 ...
 * @example
 * ```typescript
 * const stake = new BtcDepositLbtc(ctx, {
 ...
 * ```
 */
export class BtcDepositLbtc
  extends BaseBtcAction<ActionEventMap, BtcActionStatus, BtcDepositLbtcParams>
  implements IBtcDepositLbtc
{
  ...
  constructor(ctx: BtcCoreContext, params: BtcDepositLbtcParams) {
