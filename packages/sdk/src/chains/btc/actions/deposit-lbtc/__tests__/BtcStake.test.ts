...
import type { BtcDepositLbtcParams, BtcDepositLbtcProgress } from '../types';
...
describe('BtcDepositLbtc Interface', () => {
  describe('BtcDepositLbtcParams', () => {
    it('should accept valid stake parameters', () => {
      const params: BtcDepositLbtcParams = {
    ...
    it('should support different destination chains', () => {
      const ethereumParams: BtcDepositLbtcParams = {
        assetOut: AssetId.LBTC,
        destChain: Chain.ETHEREUM,
      };

      const baseParams: BtcDepositLbtcParams = {
        assetOut: AssetId.LBTC,
  ...
  describe('BtcDepositLbtc Status Transitions', () => {
  ...
  describe('BtcDepositLbtcProgress Interface', () => {
    it('should include required progress fields', () => {
      const progress: BtcDepositLbtcProgress = {
  ...
  describe('BtcDepositLbtc Method Signatures', () => {
  ...
  describe('Event Emissions', () => {
    it('should emit progress events with correct type', () => {
      const handler = vi.fn((progress: BtcDepositLbtcProgress) => {
