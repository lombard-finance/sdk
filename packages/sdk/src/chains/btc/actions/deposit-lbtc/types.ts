 ...
 *
 * @module chains/btc/actions/deposit-lbtc/types
 */
 ...
 */
export interface BtcDepositLbtcParams {
  /**
 ...
 */
export interface BtcDepositLbtcProgress extends StrategyProgress<BtcActionStatus> {
  /** Current status */
 ...
 * ```
 */
export interface BtcDepositLbtc extends MonitorableAction {
  /** Current status */
