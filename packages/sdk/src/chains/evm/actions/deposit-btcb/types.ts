 ...
 *
 * @module chains/evm/actions/deposit-btcb/types
 */
...
export { EvmOperationStatus as EvmDepositBtcbStatus } from '../../../../shared/constants/statusConstants';
 ...
 */
export interface EvmDepositBtcbParams {
  /** Input asset (BTC.b) */
  assetIn: AssetId;
  /** Output asset (LBTC) */
  assetOut: AssetId;
 ...
 */
export interface EvmDepositBtcbPrepareParams {
 ...
 * EVM Stake progress
 */
export interface EvmDepositBtcbProgress extends StrategyProgress<EvmOperationStatus> {
 ...
 * EVM Stake interface
 */
export interface IEvmDepositBtcb extends MonitorableAction {
  ...
  prepare(params: EvmDepositBtcbPrepareParams): Promise<void>;
  /**
