 ...
 *
 * @module chains/evm/actions/deposit-btcb/EvmDepositBtcb
 */
...
export class EvmDepositBtcb
  extends BaseAction<ActionEventMap, EvmOperationStatus>
  implements IEvmDepositBtcb
{
  ...
  constructor(
    ...
    private readonly params: EvmDepositBtcbParams,
  ) {
  ...
  async prepare(params: EvmDepositBtcbPrepareParams): Promise<void> {
